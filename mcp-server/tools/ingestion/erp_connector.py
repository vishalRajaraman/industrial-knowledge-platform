...
async def sync_erp_workorders_logic(system: str = "SAP", endpoint: str = "/api/workorders", limit: int = 50) -> dict:
    """
...
def register(mcp: FastMCP):
    ...
    async def sync_erp_workorders(system: str = "SAP", endpoint: str = "/api/workorders", limit: int = 50) -> dict:
        ...
        """
        return await sync_erp_workorders_logic(system, endpoint, limit)
